        ...
        <Route element={<WithNav />}>
          <Route path="/Orders" element={<Parentroute />}>
            ...
            <Route path="Service">
              ...
              <Route path="OrderList/Created" element={<ServiceCreated />} />
              <Route
              ...
              />
              <Route path="OrderList/Produced" element={<ServiceProduced />} />
              ...
              <Route path="OrderList/Recorded" element={<ServiceRecorded />} />
              <Route
                path="NewOrderSerial"
