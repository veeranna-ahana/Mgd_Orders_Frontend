      ...
      >
        ...
        <Modal.Body>
          <div className="ip-box form-bg">
            ...
            <div className="d-flex col-md-6 mb-2" style={{ gap: "10px" }}>
              <label className="form-label" style={{ whiteSpace: "nowrap" }}>
                Password
              </label>
              <input
        ...
        <Modal.Footer className="d-flex flex-row justify-content-end">
          <button className="button-style m-0 me-3" onClick={onclickOk}>
            Ok
          </button>

          <button className="button-style m-0" onClick={handleClose}>
            cancel
          </button>
        </Modal.Footer>
      </Modal>
