...
export default function PrepareScheduleTab({
  ...
  const getSalesCustomer = () => {
    getRequest(
      endpoints.getSalesCustomerdata,
      (response) => {
  ...
  const onclickpreapreScheduleButtonSales = () => {
    postRequest(endpoints.prepareScheduleSales, {
    ...
    <div>
      <div className="row">
        <div className="col-md-6">
          ...
          <button className="button-style group-button" onClick={onClickReverse}>
            Reverse
          </button>
          <button
            className="button-style group-button"
          ...
          <div className="mt-2" style={{ overflowY: "scroll",height:"200px"}}>
              ...
              <tbody className="tablebody table-space">
                {beforecombineSales.map((value, key) => {
                  const isChecked = rowselectleftSales.some(
                    (selectedItem) =>
                      selectedItem.TaskNo === value.TaskNo
                  );
                    ...
                    >
                      <td>
                        <input
                          type="checkbox"
                          checked={isChecked}
                          onChange={() => handleCheckboxChangeLeftSales(key, value)}
                        />
                      </td>
                      <td>{value.TaskNo}</td>
        ...
        <div className="col-md-6">
          ...
          <button className="button-style group-button" onClick={onClickReverse1}>
            Reverse
          </button>

          <div className="row">
            <div className="col-md-6 mt-2">
              <div style={{ height: "400px", overflowY: "scroll", overflowX: "scroll" ,marginLeft:"-20px"}}>
                    ...
                    {oderSchedule.map((item, key) => {
                      ...
                      return (
                        <tr
                          key={key}
                          className={
                            key === selectedRowsSales?.index ? "selcted-row-clr" : ""
                          }
                        >
                          <td>
                            <input
                              type="checkbox"
                              checked={isChecked}
                              onChange={() => handleCheckboxChangeSales(key, item)}
                            />
                          </td>
                          <td>{item.TaskNo}</td>
                          <td>{item.NoOfDwgs}</td>
            ...
            <div className="col-md-6 mt-2">
              <div style={{ height: "400px", overflowY: "scroll",marginLeft:"-20px"}}>
                <Table striped className="table-data border">
                  <thead className="tableHeaderBGColor table-space">
                    <tr>
                      <th>Material</th>
                    ...
                    {salesCustomerData.map((item, key) => {
                      return (
                        <tr
                          ...
                          className={
                            key === selectedCustomerSales?.index ? "selcted-row-clr" : ""
                          }
                        >
        ...
        <div>
          <div className="row">
            <div className="col-md-8 col-sm-12">
              ...
              <div className="mt-1" style={{ overflowY: "scroll",height:"180px" }}>
                <Table
                  striped
